...
public class MemoryProductRepository implements IProductRepository {
    ...
    public MemoryProductRepository(){
        ...
        products.add(new Product("123456A", "MC Lanche Feliz", "Hamburguer com queijo, salada especial e queijo", new MonetaryValue(new BigDecimal("35.00")).getValue(), Category.Meal.getValue()));
        products.add(new Product("123456B", "Quarteirão Com Queijo", "Hamburguer com queijo e salada", new MonetaryValue(new BigDecimal("28.00")).getValue(), Category.Meal.getValue()));
